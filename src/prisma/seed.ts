...
(async () => {
  ...
  await prismaTest.$executeRaw` INSERT INTO public."Client"(	host, ip, name, connected, "parentIp")	VALUES ('hostmachine', 7010, 'netproc7010', false, 7010);  `;
  await prismaTest.$executeRaw` INSERT INTO public."Client"(	host, ip, name, connected, "parentIp")	VALUES ('hostmachine', 7020, 'netproc7020', false, 7020);  `;
  await prismaTest.$executeRaw` INSERT INTO public."Client"(	host, ip, name, connected, "parentIp")	VALUES ('hostmachine', 7030, 'netproc7030', false, 7030);  `;
  await prismaTest.$executeRaw` INSERT INTO public."Client"(	host, ip, name, connected, "parentIp")	VALUES ('hostmachine', 7040, 'netproc7040', false, 7040);  `;
